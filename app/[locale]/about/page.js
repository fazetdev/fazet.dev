...
export default function About({ params }) {
  ...
  const borderPrimary = locale === 'ar' ? 'border-r-4 pr-4' : 'border-l-4 pl-4';
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                ...
                <div className="space-y-6">
                  {t.education.items.map((item, index) => (
                    <div key={index} className={`border-l-4 border-primary ${borderPrimary}`}>
                ...
                <div className="space-y-6">
                  {t.experience.items.map((item, index) => (
                    <div key={index} className={`border-l-4 border-primary ${borderPrimary}`}>
                      ...
                      <p className="text-sm text-gray-500 mt-1">{item.period}</p>
                      <ul className={`list-disc list-inside text-gray-700 mt-2 space-y-1 ${locale === 'ar' ? 'list-none' : ''}`}>
