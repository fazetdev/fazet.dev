        ...
        <section className="section-padding py-20 px-4">
          <div className="max-w-3xl mx-auto">
              ...
              <div className="border border-gray-200 rounded-xl p-8 hover:shadow-lg transition-shadow">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <a href={`mailto:${t.contacts.email}`} className="text-primary hover:text-blue-700 hover:underline flex items-center">
                      <svg className={`w-5 h-5 ${locale === 'ar' ? 'ml-2' : 'mr-2'}`} fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <a href={t.contacts.linkedin} target="_blank" rel="noopener noreferrer" className="text-primary hover:text-blue-700 hover:underline flex items-center">
                      <svg className={`w-5 h-5 ${locale === 'ar' ? 'ml-2' : 'mr-2'}`} fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <a href={t.contacts.github} target="_blank" rel="noopener noreferrer" className="text-primary hover:text-blue-700 hover:underline flex items-center">
                      <svg className={`w-5 h-5 ${locale === 'ar' ? 'ml-2' : 'mr-2'}`} fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="border border-gray-200 rounded-xl p-8 hover:shadow-lg transition-shadow">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <a href={t.contacts.whatsapp} target="_blank" rel="noopener noreferrer" className="text-primary hover:text-blue-700 hover:underline flex items-center">
                      <svg className={`w-5 h-5 ${locale === 'ar' ? 'ml-2' : 'mr-2'}`} fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <a href={t.contacts.telegram} target="_blank" rel="noopener noreferrer" className="text-primary hover:text-blue-700 hover:underline flex items-center">
                      <svg className={`w-5 h-5 ${locale === 'ar' ? 'ml-2' : 'mr-2'}`} fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-12 text-center">
              <div className="bg-primary/5 border border-primary/20 rounded-xl p-6 inline-block">
                <p className="text-gray-700 mb-3">
                  {locale === "ar" 
                    ? "للحصول على موعد أو استشارة، يرجى زيارة صفحة الحجز." 
                    : "For appointments or consultations, please visit the booking page."}
                </p>
                <Link href={`/${locale}/book`} className="bg-primary text-white px-6 py-3 rounded-xl font-semibold hover:bg-primary-dark transition-all duration-300 shadow-lg inline-flex items-center">
                  {locale === "ar" ? "اذهب إلى صفحة الحجز" : "Go to booking page"}
                  <span className={`transition-transform ${locale === 'ar' ? 'mr-2 group-hover:-translate-x-1' : 'ml-2 group-hover:translate-x-1'}`}>
                    {locale === "ar" ? '←' : '→'}
                  </span>
                </Link>
              </div>
