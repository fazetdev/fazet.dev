      ...
      <section className="section-padding py-20 px-4">
        <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <a 
                    ...
                    // FIX 2: Changed color to primary (Navy Blue)
                    className="text-primary hover:text-blue-700 hover:underline flex items-center"
                  >
                    {/* FIX 3: Conditional margin for icons */}
          ...
          <div className="mt-12 text-center">
            {/* FIX 4: Changed background/border colors for consistency */}
            <div className="bg-primary/5 border border-primary/20 rounded-xl p-6 inline-block">
              ...
              <Link 
                href={`/${locale}/book`}
                // FIX 5: Use home page button styling
                className="bg-primary text-white px-6 py-3 rounded-xl font-semibold hover:bg-primary-dark transition-all duration-300 shadow-lg inline-flex items-center"
              >
                {locale === "ar" ? "اذهب إلى صفحة الحجز" : "Go to booking page"}
                {/* FIX 6: Flip arrow and hover movement for RTL */}
